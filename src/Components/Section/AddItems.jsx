  ...
  return (
    <div className="container-fluid">
      ...
      <div className="input-group mb-2">
        ...
        <input type="text" aria-label="First name" className="form-control addItemTag-0" />
        <input type="text" aria-label="Last name" className="form-control addItemTag-1" />
        <input type="text" aria-label="Last name" className="form-control addItemTag-2" />
      </div>
